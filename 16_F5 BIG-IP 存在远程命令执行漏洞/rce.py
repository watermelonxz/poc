...
def main():
    ...
    banner()
    #argparse模块处理命令行参数
    parser = argparse.ArgumentParser(description="F5 BIG-IP 远程命令执行漏洞")
...
'''
    ...
    try:
        ...
        # print(str(re.text))
        if re.status_code == 200 and "uid" in str(re.text):
            # print("200啦")
            print(f'[+++]该{target}存在F5 BIG-IP 远程命令执行漏洞')
